          ...
          <div className='grid grid-cols-3 '>
              <div className='col-span-2 space-y-3 p-8'> 
                  ...
                  <div> 
                    ...
                    <input type='number' className='border border-gray-400 w-full h-[35px] outline-none pl-2 text-[17px]'/>
                  </div>
                  <div> 
                  ...
                  <div>
                    <button className='bg-[#FF424E] w-full h-[35px] outline-none pl-2 text-[17px] text-white rounded-sm'>Đăng ký</button>
                  </div>
